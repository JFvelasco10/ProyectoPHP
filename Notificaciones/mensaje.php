...
<table id="tbl9"style="width:95%" border=0>
      <tr>
        <th id="txt7" align="center" style="width:0px">ASUNTO</th>
        <th id="txt7" align="center" style="width:2000px">CONTENIDO</th>
        <th id="txt7" align="center">ESTADO</th>
        <th id="txt7" align="center">ELIMINAR</th>
      </tr>
       <?php 
		try { 
      ...
      <tr>
        ...
        <td id="txt8" align="center" style="width:15px;"><?php echo $consulta['est_men']?></td>
        <td id="qqq"><a href="eliminar2.php?cod=<?php echo $consulta['id_men']?>"><img id="www" src="Img/eliminar.png" height="25"></td>
      </tr>
      <?php
			}
		} catch(Exeption $e){
